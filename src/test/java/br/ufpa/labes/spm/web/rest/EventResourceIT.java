...
public class EventResourceIT {
    ...
    private static final LocalDate SMALLER_WHEN = LocalDate.ofEpochDay(-1L);

    private static final Boolean DEFAULT_IS_CREATED_BY_APSEE = false;
    ...
    public static Event createEntity(EntityManager em) {
        Event event = new Event()
            .why(DEFAULT_WHY)
            .when(DEFAULT_WHEN)
            .isCreatedByApsee(DEFAULT_IS_CREATED_BY_APSEE);
        return event;
    }
    /**
    ...
    public void createEvent() throws Exception {
        ...
        assertThat(testEvent.getWhy()).isEqualTo(DEFAULT_WHY);
        assertThat(testEvent.getWhen()).isEqualTo(DEFAULT_WHEN);
        assertThat(testEvent.isIsCreatedByApsee()).isEqualTo(DEFAULT_IS_CREATED_BY_APSEE);
    }
    ...
    public void getEvent() throws Exception {
        ...
        restEventMockMvc.perform(get("/api/events/{id}", event.getId()))
            ...
            .andExpect(jsonPath("$.isCreatedByApsee").value(DEFAULT_IS_CREATED_BY_APSEE.booleanValue()));
    }
    ...
    public void updateEvent() throws Exception {
        ...
        Event testEvent = eventList.get(eventList.size() - 1);
        assertThat(testEvent.getWhy()).isEqualTo(UPDATED_WHY);
        assertThat(testEvent.getWhen()).isEqualTo(UPDATED_WHEN);
        assertThat(testEvent.isIsCreatedByApsee()).isEqualTo(UPDATED_IS_CREATED_BY_APSEE);
    }
