...
public interface DynamicModeling {
	...
	public Integer defineAsDecomposed(String act_id)
			throws RepositoryQueryException, ModelingException;
	 ...
	 * Rule G1.8 and G1.9
	 */
	public Integer defineAsNormal(String act_id) throws RepositoryQueryException,
			ModelingException;
	...
	public Integer defineAutomatic(String auto_id, Script script,
			Collection parameters) throws RepositoryQueryException;

	/**
	 * Rule G1.16 The Activity in Parameter must be an Automatic activity!
	 */
	public Integer defineAutomatic(String auto_id,
			ClassMethodCall cmc, Collection parameters) throws RepositoryQueryException;

	/**
	 * Rule G1.17 till G1.103 WARNING: This Method contains Dynamic Changes
	 * related code!
	 */
	public void deleteActivity(String act_id) throws RepositoryQueryException,
			WebapseeException;
	...
	public Integer defineType_ArtifactConnection(String con_id,
			String type) throws RepositoryQueryException;

	/**
	 * Rule G2.3 and G2.4
	 */
	public Integer changeType_ArtifactConnection(String con_id,
			String newType) throws RepositoryQueryException;

	/**
	 * Rule G2.5, G2.6, G2.7 and G2.8
	 */
	public Integer defineInstance_ArtifactConnection(String con_id,
			String artifact_id) throws RepositoryQueryException, ModelingException;
	...
	public Integer defineOutput_ArtifactConnection(String con_id,
			String act_id) throws RepositoryQueryException, ModelingException,
			WebapseeException;
	...
	public Integer defineInput_ArtifactConnection_Activity(
			String con_id, String act_id) throws RepositoryQueryException,
			ModelingException;
	...
	public Integer defineInput_ArtifactConnection_Multiple(
			String con_id, String mcon_id) throws RepositoryQueryException,
			ModelingException;
	...
	public Integer removeInput_ArtifactConnection_Multiple(
			String con_id, String multi_id) throws RepositoryQueryException,
			ModelingException;
	 ...
	 */
	public void deleteConnection(String con_id) throws RepositoryQueryException,
			WebapseeException;
	...
	public Integer addSimpleConnection(String act_id_from,
			String act_id_to, String dependency) throws RepositoryQueryException,
			WebapseeException;
	...
	public Integer addFeedbackConnection(String act_id_from,
			String act_id_to) throws RepositoryQueryException, ModelingException,
			ModelingWarning;
	...
	public void removeMultiConPredecessorConnection(String con_id,
			String from_con_id) throws RepositoryQueryException, WebapseeException;
	...
	public void removeMultiConPredecessorActivity(String con_id,
			String act_id) throws RepositoryQueryException, WebapseeException;
	...
	public void removeMultiConSuccessorConnection(String con_id,
			String to_con_id) throws RepositoryQueryException, WebapseeException;
	...
	public boolean defineRequiredAgent(String act_id, String role_id,
			String ag_id) throws RepositoryQueryException, WebapseeException;
	...
	public void removeCompleteRequiredAgent(String normal_id,
			String agent_id, String role_id) throws RepositoryQueryException,
			ModelingException;

	public void removeCompleteRequiredWorkGroup(String normal_id,
			String WorkGroup_id, String WorkGroupType_id) throws RepositoryQueryException,
			ModelingException;

	public void removeCompleteRequiredResource(String normal_id,
			String resource_id, String resourceType_id) throws RepositoryQueryException,
			ModelingException;
	...
	public Integer addRequiredResourceType(String act_id,
			String resType_id) throws RepositoryQueryException, ModelingException;
	...
	public Integer changeRequiredResourceType(String act_id,
			String oldResType_id, String newResType_id) throws RepositoryQueryException,
			ModelingException;
	...
	public Integer defineRequiredResource(String act_id,
			String res_id, float amount_needed) throws RepositoryQueryException,
	...
	public void changeRequiredResourceAmount(String act_id,
			String res_id, float new_amount_needed) throws RepositoryQueryException,
			ModelingException;
	...
	public Integer getGlobalEvents(String act_id) throws RepositoryQueryException,
			ModelingException;
}
