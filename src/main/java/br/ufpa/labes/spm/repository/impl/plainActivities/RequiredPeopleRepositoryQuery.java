...
public class RequiredPeopleRepositoryQuery extends BaseRepositoryQueryImpl<RequiredPeople, Long>
    implements IRequiredPeopleRepositoryQuery {

  protected RequiredPeopleRepositoryQuery(Class<RequiredPeople> businessClass) {
    super(businessClass);
  }

  public RequiredPeopleRepositoryQuery() {
