...
public class RepositoryRepositoryQuery extends BaseRepositoryQueryImpl<VCSRepository, Long> implements IRepositoryRepositoryQuery {
  protected RepositoryRepositoryQuery(Class<VCSRepository> businessClass) {
    super(businessClass);
  }

  public RepositoryRepositoryQuery() {
