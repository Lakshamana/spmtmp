...
import br.ufpa.labes.spm.repository.interfaces.plainActivities.IReqAgentRepositoryQuery;
import br.ufpa.labes.spm.domain.ReqAgent;

public class ReqAgentRepositoryQuery extends BaseRepositoryQueryImpl<ReqAgent, Long> implements IReqAgentRepositoryQuery {

  protected ReqAgentRepositoryQuery(Class<ReqAgent> businessClass) {
    super(businessClass);
  }

  public ReqAgentRepositoryQuery() {
