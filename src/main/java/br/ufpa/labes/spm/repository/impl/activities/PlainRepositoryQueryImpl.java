...
public class PlainRepositoryQueryImpl implements PlainRepositoryQuery{
  @PersistenceContext
  private EntityManager em;

  private Class<Plain> businessClass;
  ...
  private String concatOidOnString(String oldIdent, Plain t) {
    Method method = null;
    String oid = "";
    try {
