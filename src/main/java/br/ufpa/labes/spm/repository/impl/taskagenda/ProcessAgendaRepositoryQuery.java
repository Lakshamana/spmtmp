...
public class ProcessAgendaRepositoryQuery extends BaseRepositoryQueryImpl<ProcessAgenda, Long> implements IProcessAgendaRepositoryQuery {

  @Autowired
  private TaskRepository taskRepository;

  protected ProcessAgendaRepositoryQuery(Class<ProcessAgenda> businessClass) {
    super(businessClass);
  }

  public ProcessAgendaRepositoryQuery() {
