...
public class ArtifactRepositoryQuery extends BaseRepositoryQueryImpl<Artifact, Long> implements IArtifactRepositoryQuery {

  protected ArtifactRepositoryQuery(Class<Artifact> businessClass) {
    super(businessClass);
  }

  public ArtifactRepositoryQuery() {
