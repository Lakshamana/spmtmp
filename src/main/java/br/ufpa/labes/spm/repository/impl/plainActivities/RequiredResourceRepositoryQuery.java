...
public class RequiredResourceRepositoryQuery extends BaseRepositoryQueryImpl<RequiredResource, Long>
    implements IRequiredResourceRepositoryQuery {

  protected RequiredResourceRepositoryQuery(Class<RequiredResource> businessClass) {
    super(businessClass);
  }

  public RequiredResourceRepositoryQuery() {
