...
public class TaskRepositoryQuery extends BaseRepositoryQueryImpl<Task, Long> implements ITaskRepositoryQuery {

  protected TaskRepositoryQuery(Class<Task> businessClass) {
    super(businessClass);
  }

  public TaskRepositoryQuery() {
    super(Task.class);
  }
