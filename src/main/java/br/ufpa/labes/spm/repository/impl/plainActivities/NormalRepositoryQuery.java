...
public class NormalRepositoryQuery extends BaseRepositoryQueryImpl<Normal, Long> implements INormalRepositoryQuery {

  protected NormalRepositoryQuery(Class<Normal> businessClass) {
    super(businessClass);
  }

  public NormalRepositoryQuery() {
    super(Normal.class);
  }
