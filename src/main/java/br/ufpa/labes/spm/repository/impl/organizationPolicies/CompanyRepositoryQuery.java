...
public class CompanyRepositoryQuery extends BaseRepositoryQueryImpl<Company, Long> implements ICompanyRepositoryQuery {

  protected CompanyRepositoryQuery(Class<Company> businessClass) {
    super(businessClass);
  }

  public CompanyRepositoryQuery() {
    super(Company.class);
  }
