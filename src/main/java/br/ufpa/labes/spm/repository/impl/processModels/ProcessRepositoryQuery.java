...
public class ProcessRepositoryQuery extends BaseRepositoryQueryImpl<Process, Long> implements IProcessRepositoryQuery {

  protected ProcessRepositoryQuery(Class<Process> businessClass) {
    super(businessClass);
  }

  public ProcessRepositoryQuery() {
    super(Process.class);
  }
