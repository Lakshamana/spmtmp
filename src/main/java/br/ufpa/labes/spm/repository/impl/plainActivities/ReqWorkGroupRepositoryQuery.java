...
import br.ufpa.labes.spm.repository.interfaces.plainActivities.IReqWorkGroupRepositoryQuery;
import br.ufpa.labes.spm.domain.ReqWorkGroup;

public class ReqWorkGroupRepositoryQuery extends BaseRepositoryQueryImpl<ReqWorkGroup, Long> implements IReqWorkGroupRepositoryQuery {

  protected ReqWorkGroupRepositoryQuery(Class<ReqWorkGroup> businessClass) {
    super(businessClass);
  }

  public ReqWorkGroupRepositoryQuery() {
