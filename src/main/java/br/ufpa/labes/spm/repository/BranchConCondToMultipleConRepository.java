...
@Repository
public interface BranchConCondToMultipleConRepository extends BaseRepositoryQuery<BranchConCondToMultipleCon, Long>, JpaRepository<BranchConCondToMultipleCon, Long> {
