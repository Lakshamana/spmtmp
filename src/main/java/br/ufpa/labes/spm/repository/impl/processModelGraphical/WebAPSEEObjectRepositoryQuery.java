...
public class WebAPSEEObjectRepositoryQuery extends BaseRepositoryQueryImpl<WebAPSEEObject, Long>
    implements IWebAPSEEObjectRepositoryQuery {

  public WebAPSEEObjectRepositoryQuery() {
    super(WebAPSEEObject.class);
  }

  protected WebAPSEEObjectRepositoryQuery(Class<WebAPSEEObject> businessClass) {
    super(businessClass);
  }
