...
/**
 * REST controller for managing {@link br.ufpa.labes.spm.domain.Tag}.
 */
@RestController
@RequestMapping("/api")
public class TagResource {
    ...
    private final GenericRepository<Tag, Long> tagRepository;

    public TagResource(GenericRepository<Tag, Long> tagRepository) {
