...
public class WorkGroupTypeResource {
    ...
    private final GenericRepository<WorkGroupType, Long> workGroupTypeRepository;

    public WorkGroupTypeResource(GenericRepository<WorkGroupType, Long> workGroupTypeRepository) {
